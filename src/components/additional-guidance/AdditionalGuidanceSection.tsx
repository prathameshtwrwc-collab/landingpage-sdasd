      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={{ hidden: { opacity: 0, y: 25 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut" } } }} className="relative z-[1] mx-auto max-w-[1120px] px-[20px] max-[389px]:px-[16px] max-[389px]:pr-[44px] md:px-[32px] lg:px-[48px] pt-[36px] md:pt-[42px] lg:pt-[46px] pb-[38px] md:pb-[44px] lg:pb-[48px] min-w-0">
        <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_390px] lg:grid-cols-[minmax(0,1fr)_470px] gap-[0px] md:gap-[36px] lg:gap-[58px] items-center min-w-0">
          <motion.div variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0, transition: { duration: 0.45, ease: "easeOut" } } }} className="w-full max-w-[500px] text-left min-w-0">
            <h2
              className="m-0 text-[clamp(24px,6.5vw,30px)] leading-[1.2] md:text-[clamp(31px,3.8vw,37px)] lg:text-[clamp(36px,2.7vw,43px)] font-semibold text-[#F59A00] text-left"
              style={{
            ...
            <p
              className="m-0 text-[clamp(15px,4.5vw,18px)] leading-[1.45] md:text-[18px] md:leading-[1.5] lg:text-[20px] lg:leading-[1.5] font-medium text-[#171717] text-left"
              style={{
                fontFamily: "Poppins, sans-serif",
                fontWeight: 500,
                maxWidth: "470px",
            ...
            <p
              className="m-0 text-[clamp(14px,4vw,16px)] leading-[1.58] md:text-[17px] lg:text-[18px] lg:leading-[1.58] font-medium text-[#171717] text-left"
              style={{
                fontFamily: "Poppins, sans-serif",
                fontWeight: 500,
                maxWidth: "500px",
