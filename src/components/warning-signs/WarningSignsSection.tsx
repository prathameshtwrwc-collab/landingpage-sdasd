...
// Simple black line-art icons – 68x68, stroke #171717, stroke-width 1.6, fill none
const IconStyle = {
  stroke: "#171717",
  strokeWidth: 1.6,
  fill: "none",
  ...
  return (
    <svg width="68" height="68" viewBox="0 0 68 68" aria-hidden="true">
      <g {...IconStyle}>
        ...
        {/* Zzz – three Z shapes upper right */}
  ...
  return (
    ...
    >
      <div className="relative z-[1] mx-auto max-w-[1120px] px-[20px] max-[389px]:px-[16px] md:px-[32px] lg:px-[48px] pt-[36px] md:pt-[40px] lg:pt-[46px] pb-[38px] md:pb-[44px] lg:pb-[48px] min-w-0">
        ...
        {/* Subtitle */}
        <p
          className="m-0 mx-auto text-[14px] leading-[1.45] md:text-[16px] md:leading-[1.45] lg:text-[17px] lg:leading-[1.45] font-normal text-center text-[#171717]"
          style={{ fontFamily: "Poppins, sans-serif", fontWeight: 400, marginBottom: "24px" }}
        >
          Seek professional evaluation if you experience:
        </p>

        {/* Main outlined panel — padding 24 14 mobile */}
        <div
        ...
        >
          {/* Warning Grid — repeat(2, minmax(0,1fr)) gap 28 14 */}
            ...
            {warningSigns.map((item) => {
              ...
              return (
                <div key={item.label} className="flex flex-col items-center text-center">
                  ...
                  <p
                    className="text-[12.5px] leading-[1.4] md:text-[13px] md:leading-[1.4] lg:text-[14px] lg:leading-[1.4] font-normal text-center text-[#171717] break-words"
                    style={{
