...
const remRows = ["Learning, Memory and Emotional Processing", "20 to 25 percent of total sleep", "Dreaming, emotional processing, learning, creativity", "Refreshes the mind"];
const stripImages = [
  ...
  return (
    ...
    >
      <div className="relative z-[1] mx-auto max-w-[1180px] px-[20px] max-[389px]:px-[16px] md:px-[32px] lg:px-[48px] pt-[36px] md:pt-[40px] lg:pt-[44px] pb-[38px] md:pb-[40px] lg:pb-[46px] min-w-0">
        <h2 className="m-0 mx-auto text-[clamp(23px,7vw,28px)] leading-[1.18] tracking-[-0.02em] md:text-[27px] lg:text-[30px] font-semibold text-center text-[#F59A00]" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, letterSpacing: "-0.02em", marginBottom: "8px" }}>
          Understanding Sleep Cycles
        </h2>
        <p className="m-0 mx-auto text-[14px] leading-[1.6] md:text-[16px] lg:text-[17px] font-medium text-center text-[#3B35A3]" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 500, marginBottom: "10px" }}>
          Your body heals in sleep. Your brain organizes your future in sleep.
        </p>
        <p className="m-0 mx-auto text-[14px] leading-[1.6] md:text-[14px] lg:text-[15px] font-normal text-center text-[#171717]" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 400, maxWidth: "920px", marginBottom: "24px" }}>
        ...
        <div className="hidden md:grid grid-cols-[130px_165px_1fr_16px_1fr] lg:grid-cols-[170px_190px_1fr_16px_1fr] gap-0 items-start w-full min-w-0">
          ...
          <div className="flex flex-col w-full min-w-0">
            ...
            <div className="grid grid-rows-[repeat(4,minmax(78px,auto))] min-w-0">
              {categoryLabels.map((label) => (
                <div key={label} className="flex items-center px-[12px] lg:px-[18px] text-[14px] lg:text-[16px] leading-[1.3] font-semibold text-[#171717] border-b border-[#DDB642] min-w-0" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600 }}>
                  {label}
                </div>
              ))}
            </div>
          ...
          <div className="flex flex-col w-full min-w-0">
            <div className="h-[42px] flex items-center justify-center bg-[#F4C623] text-[#171717] text-[15px] lg:text-[17px] leading-[1] font-semibold" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, borderRadius: 0 }}>
              NREM Sleep
            </div>
            <div className="grid grid-rows-[repeat(4,minmax(78px,auto))] min-w-0">
              {nremRows.map((c) => (
                <div key={c} className="flex items-center px-[10px] lg:px-[18px] text-[13px] lg:text-[15px] leading-[1.45] font-normal text-[#171717] border-b border-[#DDB642] min-w-0" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 400 }}>
                  {c}
                </div>
              ))}
            </div>
        ...
        <div className="block md:hidden w-full min-w-0">
          ...
          <div className="w-full min-w-0" style={{ marginTop: "20px" }}>
            <div className="h-[44px] flex items-center justify-center bg-[#F4C623] text-[#171717] text-[17px] font-semibold" style={{ height: "44px", fontSize: "17px" }}>
              NREM Sleep
            </div>
            {categoryLabels.map((label, idx) => (
              <div key={`nrem-m-${label}`} className="grid border-b border-[#DDB642] min-w-0" style={{ gridTemplateColumns: "minmax(112px, 36%) minmax(0, 1fr)" }}>
                <div className="flex items-center text-[#171717] min-w-0" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "13px", padding: "12px 8px" }}>
                  {label}
                </div>
                <div className="flex items-center text-[#171717] min-w-0" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 400, fontSize: "13px", lineHeight: "1.45", padding: "12px 8px" }}>
                  {nremRows[idx]}
                </div>
              </div>
            ))}
        ...
        <div className="w-full mt-[28px] px-[18px] md:px-[28px] lg:px-[36px] py-[24px] md:py-[24px] lg:py-[28px] flex flex-col items-center justify-center text-center min-h-[145px] min-w-0" style={{ background: "#383477", borderRadius: 0, padding: "24px 18px" }}>
          <p className="m-0 text-[15px] leading-[1.5] md:text-[16px] lg:text-[18px] font-semibold text-white text-center" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "15px", lineHeight: "1.5" }}>
            NREM Sleep supports physical restoration.
          </p>
          <p className="m-0 mt-[2px] text-[15px] leading-[1.5] md:text-[16px] lg:text-[18px] font-semibold text-center" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, color: "#F4C623", fontSize: "15px", lineHeight: "1.5" }}>
            REM Sleep supports mental and emotional restoration.
          </p>
          <p className="m-0 mt-[2px] text-[15px] leading-[1.5] md:text-[16px] lg:text-[18px] font-semibold text-white text-center" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "15px", lineHeight: "1.5" }}>
