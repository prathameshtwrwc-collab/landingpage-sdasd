...
- Added right-click context menu on all dashboard pages (excluding header/sidebar/nav):
  - Right-click anywhere in the dashboard content area to see a "Help & Support" option
  - Clicking navigates directly to `/dashboard/help`
